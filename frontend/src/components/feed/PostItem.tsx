        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              ...
              {post.userId.specialBadge && (
                <div className="flex-shrink-0">
                  <span 
                    className="inline-flex items-center gap-1 text-xs px-2 py-1 rounded-full text-white font-medium"
                    style={{ backgroundColor: post.userId.specialBadge.color }}
                  >
                    <span>{post.userId.specialBadge.icon}</span>
                    <span>{post.userId.specialBadge.label}</span>
                  </span>
                </div>
              )}
            </div>
